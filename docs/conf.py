# -*- coding: utf-8 -*-
#
# cutplace documentation build configuration file, created by
...
# of the sidebar.
html_logo = "images/cutplace_logo_64x64.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "images/cutplace_logo_32x32.ico"
