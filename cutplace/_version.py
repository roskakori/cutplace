...
tag_prefix = "v"
parentdir_prefix = "cutplace-"
versionfile_source = "cutplace/_version.py"
...
def get_versions(default={"version": "unknown", "full": "unknown"}, verbose=False):
    ...
    try:
        ...
        for _ in range(len(versionfile_source.split('/'))):
